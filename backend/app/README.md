...
| `api/collaboration/` | Removed. The single-user-per-project model replaced multi-user co-editing; the `ws.py`/`locks.py` files here are inert stubs and the folder can be deleted. |
